...
describe('/orders', function () {
    var body = 'order history', token, newUser;
    ...
    describe('GET /', function () {
        it('should return all orders', function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db_1.default.query("INSERT INTO orders\n            ( user_id, body, order_date )\n        VALUES \n            ('?', ?, NOW())", [newUser.insertId, body])];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, supertest_1.default(index_1.default).get('/orders').set('x-auth-token', token)];
                    case 2:
                        res = _a.sent();
                        expect(res.status).toBe(200);
                        expect(res.body.some(function (p) { return p.body === body; })).toBeTruthy();
                        return [2 /*return*/];
                }
            });
        }); });
    ...
    describe('POST /', function () {
        ...
        it('should save order if it is valid', function () { return __awaiter(void 0, void 0, void 0, function () {
            var res, addedOrder;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        res = _a.sent();
                        return [4 /*yield*/, db_1.default.query('SELECT * from orders WHERE user_id = ?', [newUser.insertId])];
                    case 2:
                        addedOrder = _a.sent();
