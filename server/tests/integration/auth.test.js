...
describe('auth middleware', function () {
    var newUser = db_1.default.query("INSERT INTO users( username, email, password, date_created )\n    VALUES('John', 'test@mail.ru', '123456', NOW())");
    var token = jsonwebtoken_1.default.sign({ uid: newUser.insertId, username: 'John', admin: true }, config_1.default);
    var name = 'pizza';
    ...
    afterAll(function () {
        db_1.default.query('DELETE FROM orders');
        db_1.default.query('DELETE FROM users');
        db_1.default.end();
    });
    it('should return 200 if token is valid', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
    ...
    it('should return 400 if token is invalid', function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
